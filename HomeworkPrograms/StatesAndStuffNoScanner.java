...
public class StatesAndStuffNoScanner {
	...
	//Set more testInputs
	public void setTestClassInput(String moreTestInput) {
		this.testClassInput.
	}
	
	//Class constructor
	public StatesAndStuffNoScanner() {
	...
	public static void main(String[] args) {
		...
		while(userEnteredStatesCount <= 50 && !inputState.equalsIgnoreCase("None")) {
			if(checkAddUserState(inputState.toLowerCase())) {
				System.out.println(getStateBirdFlower(inputState.toLowerCase()));
			} else {
